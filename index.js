...
// Since the nested function is inside the function myFunction, it allows access to anything that is in that function. A function can look up to a function if its inside it, however it can't look down inside another function. 
...
const zooAnimals = [
  ...
  */
  ...
  function USApop(data){
    const popUSA = data.reduce(function(acc, item){
